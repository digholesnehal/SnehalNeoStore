    ...
    render() {
        return (
            <View style={styles.bg}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => { this.props.navigation.closeDrawer(); this.props.navigation.navigate('ProductList', { ID: 3, Name: 'Sofas' }) }}>
                    <View style={styles.partitions}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => { this.props.navigation.closeDrawer(); this.props.navigation.navigate('ProductList', { ID: 2, Name: 'Chairs' }) }}>
                    <View style={styles.partitions}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => { this.props.navigation.closeDrawer(); this.props.navigation.navigate('ProductList', { ID: 4, Name: 'Cupboards' }) }}>
                    <View style={styles.partitions}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => { this.props.navigation.closeDrawer(); this.props.navigation.navigate('MyAccount') }}>
                    <View style={styles.partitions}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => { this.props.navigation.closeDrawer(); this.props.navigation.navigate('Tables') }}>
                    <View style={styles.partitions}>
